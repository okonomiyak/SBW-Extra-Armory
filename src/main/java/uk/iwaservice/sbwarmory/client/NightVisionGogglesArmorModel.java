...
public class NightVisionGogglesArmorModel extends GeoModel<NightVisionGogglesItem> {

    private static final ResourceLocation MODEL =
            new ResourceLocation(SbwArmoryMod.MODID, "geo/armor/night_vision_goggles.geo.json");
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SbwArmoryMod.MODID, "textures/armor/night_vision_goggles.png");
