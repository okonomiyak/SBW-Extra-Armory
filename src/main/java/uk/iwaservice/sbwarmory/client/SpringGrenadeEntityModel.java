...
public class SpringGrenadeEntityModel extends GeoModel<SpringGrenadeEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(SpringGrenadeEntity animatable) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(SpringGrenadeEntity animatable) {
        return TEXTURE;
    }

    @Override
    public ResourceLocation getAnimationResource(SpringGrenadeEntity animatable) {
        return ANIMATION;
    }
}
