...
import uk.iwaservice.sbwarmory.client.ClusterGrenadeItemModel;
...
/** Hand-thrown grenade; the entity itself detects the imminent impact and splits into live explosive grenades. */
public class ClusterGrenadeItem extends Item implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final GeoItemRenderer<ClusterGrenadeItem> renderer = new GeoItemRenderer<>(new ClusterGrenadeItemModel());
